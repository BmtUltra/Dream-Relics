...
public class ChestLootInjector {
    ...
    private static void injectLootTable(LootTableLoadEvent event, ResourceLocation currentTable,
        ...
        LootPool bonusPool = LootPool.lootPool()
                ...
                .add(net.minecraft.world.level.storage.loot.entries.NestedLootTable.lootTableReference(
                        net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.parse(lootTableRef))))
