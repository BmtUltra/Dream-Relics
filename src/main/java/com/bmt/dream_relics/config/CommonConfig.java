...
public class CommonConfig {
    ...
    public static final ModConfigSpec.IntValue CHARGE_TIME = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue ECHO_EARRING_TRIGGER_CHANCE = BUILDER
            .comment("Trigger chance for Echo Earring sonic wave (0.0 - 1.0)")
            .defineInRange("echoEarringTriggerChance", 0.30, 0.0, 1.0);

    public static final ModConfigSpec.DoubleValue ECHO_EARRING_EXTRA_DAMAGE_MULTIPLIER = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue ECHO_EARRING_RANGE = BUILDER
            .comment("Range in blocks for Echo Earring sonic wave")
            .defineInRange("echoEarringRange", 8.0, 1.0, 64.0);

    public static final ModConfigSpec.DoubleValue ECHO_EARRING_WIDTH = BUILDER
            .comment("Width in blocks for Echo Earring sonic wave hitbox")
            .defineInRange("echoEarringWidth", 0.4, 0.1, 5.0);

    public static final ModConfigSpec.DoubleValue HEART_VOICE_PENDANT_MAX_DAMAGE_PERCENT = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue ENDLESS_DREAM_TRIGGER_CHANCE = BUILDER
    ...
    public static final ModConfigSpec.IntValue ENDLESS_DREAM_SLEEP_DURATION = BUILDER
            .comment("Sleep duration in ticks for Endless Dream (20 ticks = 1 second)")
            .defineInRange("endlessDreamSleepDuration", 60, 1, 1200);

    public static final ModConfigSpec.DoubleValue TASSEL_RING_DAMAGE_MULTIPLIER_MAX = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue ROYAL_CROWN_PET_DAMAGE_REDUCTION = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue ROYAL_CROWN_PET_DAMAGE_BOOST = BUILDER
    ...
    public static final ModConfigSpec.IntValue DREAM_TOTEM_EFFECT_RANGE = BUILDER
            .comment("Effect range in blocks for Dream Totem sleep aura")
            .defineInRange("dreamTotemEffectRange", 16, 1, 64);

    public static final ModConfigSpec.IntValue DREAM_TOTEM_SLEEP_DURATION = BUILDER
            .comment("Sleep duration in ticks for Dream Totem aura (20 ticks = 1 second)")
            .defineInRange("dreamTotemSleepDuration", 200, 1, 1200);

    public static final ModConfigSpec.IntValue DREAM_TOTEM_COOLDOWN = BUILDER
    ...
    public static final ModConfigSpec.IntValue DARK_WHISPER_DAGGER_MUTE_DURATION = BUILDER
